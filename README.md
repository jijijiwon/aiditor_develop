...
<table>
  ...
  <tr>
    ...
    <td>
      ...
      <img src="https://img.shields.io/badge/Google%20Sheets-34A853?style=for-the-badge&logo=GoogleSheets&logoColor=ffffff"/>&nbsp
    </td>
  </tr>
  <tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td> 칼, 총, 담배, 손가락 욕 중 선택한 라벨을 모자이크합니다. 편집 요청 후 편집이 완료되면 이메일 수신 동의자에 한하여 이메일이 발송됩니다. </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td> 신용카드, 영수증, 자동차 번호판 중 선택한 라벨을 모자이크합니다. 편집 요청 후 편집이 완료되면 이메일 수신 동의자에 한하여 이메일이 발송됩니다. </td>
      <td> 선택한 사용자를 제외한 타인을 모자이크합니다. 편집 요청 후 편집이 완료되면 이메일 수신 동의자에 한하여 이메일이 발송됩니다. </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td> 실시간으로 웹캠에서 감지되는는 칼, 총, 담배, 손가락 욕을 모자이크합니다. </td>
      <td> 실시간으로 웹캡에서 감지되는 신용카드, 영수증, 자동차 번호판을 모자이크합니다. </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td> 문의 할 내용이 있을 때 작성하기 버튼을 눌러 문의글을 작성할 수 있습니다. 댓글로 답변이 완료되면 이메일 수신 동의자에 한하여 이메일이 발송됩니다. 게시글 확인은 본인과 관리자만 가능하며, 댓글 작성은 관리자만 가능합니다. </td>
      <td> 관리자가 공지할 내용이 있을 때 공지사항을 작성할 수 있습니다. 공지사항 작성은 관리자만 가능하며, 게시글은 로그인하지 않아도 확인할 수 있습니다. </td>
    </tr>
  </tbody>
</table>
...
<table>
  <thead align="center">
    <th width="500px"> 내 정보 / 관리자 페이지 </th>
  ...
  <tbody>
    ...
    <tr>
      <td> 왼쪽의 내 정보 혹은 오른쪽 상단의 이름을 클릭하여 내 정보를 확인할 수 있습니다. 작업중, 오류, 대기중, 완료 순으로 정렬되며 관리자의 경우 작업 목록이 아닌 사용자 목록을 확인할 수 있습니다. </td>
      <td> 내 정보의 이용권 내역 옆의 버튼을 클릭하여 이용권을 구매하는 페이지로 이동할 수 있습니다. 원하는 항목을 골라 이용권을 구매할 수 있습니다. </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td> 수정하기 버튼을 눌러 회원 정보를 수정할 수 있습니다. 이메일은 변경 불가하며, 이름과 수신 동의 여부를 수정할 수 있습니다. </td>
      <td> 수정하기 화면 왼쪽 하단의 회원 탈퇴하기를 클릭하여 회원을 탈퇴할 수 있습니다. 탈퇴 시 남은 이용권과 작업 목록이 모두 삭제된다는 안내 문구가 출력되며, 탈퇴하기를 누르면 회원을 탈퇴할 수 있습니다. </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td> 진행중이지 않은 모든 작업은 작업 목록 왼쪽의 X 버튼을 클릭하여 삭제할 수 있습니다. </td>
      <td> 작업이 완료되면 작업 완료 상세 페이지에서 작업 완료된 영상을 다운로드할 수 있는 링크를 제공합니다. 하단에는 감지 결과를 알려주며, 파일 다운로드하기 버튼을 클릭하면 편집을 맡길 때 지정했던 이름의 파일을 다운로드할 수 있습니다. </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td> 진행중인 작업인 경우 작업 상세 페이지에 작업 중이라는 문구가 출력됩니다. 대기중인 경우 몇번째로 대기중인지 확인할 수 있습니다. </td>
      <td> 오류가 발생한 경우 이메일 수신 동의자에 한하여 이메일이 발송되며, 상세 페이지에서 오류 원인을 확인할 수 있습니다. </td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      <td>
        <img src="https://github.com/user-attachments/assets/6ff6a52a-4862-4464-9b48-48968401fc55"/>
      </td>
      <td></td>
    </tr>
    <tr>
      <td> 각각 작업 완료, 답변 완료, 작업 오류 시 발송되는 이메일입니다. 링크를 클릭해 사이트로 이동하거나 작성한 게시글로 이동할 수 있습니다. </td>
      <td></td>
    </tr>
  </tbody>
</table>
...
[**AIvolution**](https://www.notion.so/accb494276954edd83978f6f46158a89?v=9972c34c950f434a9c06d907ffc16fa8&pvs=4)

----------

**To Do List 작성**

![image](https://github.com/user-attachments/assets/d1a0e822-66e3-40ca-87c9-93a6cee25b44)

**문서 정리**

![image](https://github.com/user-attachments/assets/fd73791e-e014-44e2-a49d-d09039717e48)

**Coding Convention**

![image](https://github.com/user-attachments/assets/3e79b073-1fe2-4e06-a55c-2b2eb6e089d5)


- 팀장이 매주 To do List를 작성, 회의록, 깃 사용법, 코딩 규칙 등 문서화하여 작성하였습니다.
...
**Git Issue 및 작업 브랜치 관리**

- Git Issue를 활용하여 FEATURE, Settings, BUG 등을 효율적으로 관리합니다.
- Issue 작성 후 해당하는 Issue의 브랜치를 생성하여 코드를 작성합니다.
- 작업이 완료되면 PR을 작성합니다.

**메인 브랜치 업데이트**

- PR이 제출되면 팀장이 최종적으로 확인하고 메인 브랜치(main)에 머지합니다.
- 머지 후 작업 브랜치를 삭제합니다.
...
![image](https://github.com/user-attachments/assets/c8bff68b-1eae-4020-8123-06382900a109)

- Google Sheets에 Action List를 작성하여 진행 상황을 공유하였습니다.
...
![image](https://github.com/user-attachments/assets/860552f1-5280-41fa-aa72-d266b8bc7136)

**PR**

![image](https://github.com/user-attachments/assets/c3502396-c742-4553-b1cb-306800bbb9e7)
