...
function DesM(props) {
  const items_m = ["칼", "총", "손가락 욕", "담배"];
  const [selectedLabels, setSelectedLabels] = useState(items_m);
            ...
            <div className="tooltip">
              <label className="link-keyword">
                ...
                <div className="labels-check">
                  <CheckboxList items={items_m} selectedLabels={items_m} />
                </div>
              </label>
              <div className="linktext" style={{ left: "60%", width: "60%" }}>
